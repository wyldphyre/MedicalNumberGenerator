    ...
    public void Execute()
    {
      ...
      switch (patientIdentifierStyle)
      {
        case PatientIdentifierStyle.AustralianMedicareNumber:
          ...
          {
            int firstCharacter = int.Parse(localValue[0].ToString());
            ...
            else
            {
              ...
              int ninthCharacter = int.Parse(localValue[8].ToString());
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                char veteranState = uppercaseValue[0];
                ...
                {
                  int uppercaseValueIndex = 1; // start on the second character
                  string veteranWarCode = "";
